    ...
    <div class="row">
      <div class="col-md-6 m-auto mt-5 bg-white shadow font-monospace border border-info">
        ...
        <form action="login1.php" method="POST">
          ...
          <div class="mb-3">
          <button class="w-100  fs-4 text-white bg-warning">LOGIN</button>
          </div>

          <div class="mb-3">
          <button name="submit" class="w-100  fs-4 text-white bg-warning"><a href="register.php" class="text-decoration-none text-white"> REGISTER</a></button>
          </div>
        </form>
      </div>
    </div>
